package com.qgg.practice.practice;
    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder holer1 = PropertyValuesHolder.ofFloat("scaleX",0,2);
                PropertyValuesHolder holer2 = PropertyValuesHolder.ofFloat("scaleY",0,1);
                PropertyValuesHolder holer3 = PropertyValuesHolder.ofFloat("alpha",0,1);

                ValueAnimator valueAnimator = ObjectAnimator.ofPropertyValuesHolder(view,holer1, holer2, holer3);
                valueAnimator.start();
            }
        });
    }
