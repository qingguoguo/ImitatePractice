package com.qgg.practice.fragment;
...
public class FragmentManagerHelper {
    ...
    /**
     * @param fragmentManager 管理类 FragmentManager
     * @param containerViewId 容器布局 id containerViewId
     */
    ...
    public void add(Fragment fragment) {
        ...
        // 第一个参数是 Fragment的容器 id，需要添加的 Fragment
